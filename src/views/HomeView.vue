<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200" style="color: #0ef;">Hello, I'm</p>
  ...
  <svg
    ...
    <div class="flex justify-center md:justify-start fadein-right z-50"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
